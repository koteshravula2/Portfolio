      ...
      <footer className="bg-gray-900 text-white py-8 mt-10">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="flex justify-center gap-6 text-2xl mb-4">
            <a href="mailto:koteshravula2@gmail.com" className="hover:text-blue-400">Mail📧</a>
            <a href="https://github.com/yourusername" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400">GitHub🐙</a>
            <a href="https://www.linkedin.com/in/ravulak/" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400">Linkedin💼</a>
          </div>
